            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('pengguna.update', $pengguna->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                        id="nama" value="{{ $pengguna->nama }}" placeholder="Nama ">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                        id="email" value="{{ $pengguna->email }}" placeholder="Email">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon"
                        id="telepon" value="{{ $pengguna->telepon }}" placeholder="Telepon">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                        id="alamat" value="{{ $pengguna->alamat }}" placeholder="Alamat">
